...
const TechnologyCard = ({ technology, onAdd, isSelected }: TechnologyCardProps) => {
    return (
        <div className="rounded-x1 border border-gray-200 p-6 shadow-sm">
            ...
            <span className="mt-3 inline-block rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-600">{technology.category}</span>

            <span className="mt-2 inline-block rounded-full bg-orange-100 px-3 py-1 text-sm text-orange-600">{technology.difficulty}</span>
